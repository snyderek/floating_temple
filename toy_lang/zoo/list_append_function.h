...
#ifndef TOY_LANG_ZOO_LIST_APPEND_FUNCTION_H_
#define TOY_LANG_ZOO_LIST_APPEND_FUNCTION_H_
...
class ListAppendFunction : public Function {
 public:
  ListAppendFunction();
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(ListAppendFunction);
};

}  // namespace toy_lang
}  // namespace floating_temple

#endif  // TOY_LANG_ZOO_LIST_APPEND_FUNCTION_H_
