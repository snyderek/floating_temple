...
#ifndef TOY_LANG_ZOO_GET_VARIABLE_FUNCTION_H_
#define TOY_LANG_ZOO_GET_VARIABLE_FUNCTION_H_
...
class GetVariableFunction : public Function {
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(GetVariableFunction);
};

}  // namespace toy_lang
}  // namespace floating_temple

#endif  // TOY_LANG_ZOO_GET_VARIABLE_FUNCTION_H_
