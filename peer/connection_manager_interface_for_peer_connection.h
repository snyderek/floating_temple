...
#ifndef PEER_CONNECTION_MANAGER_INTERFACE_FOR_PEER_CONNECTION_H_
#define PEER_CONNECTION_MANAGER_INTERFACE_FOR_PEER_CONNECTION_H_
...
#endif  // PEER_CONNECTION_MANAGER_INTERFACE_FOR_PEER_CONNECTION_H_
