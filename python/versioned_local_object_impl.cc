...
VersionedLocalObjectImpl::VersionedLocalObjectImpl(PyObject* py_object)
    : py_object_(CHECK_NOTNULL(py_object)) {
}

VersionedLocalObjectImpl::~VersionedLocalObjectImpl() {
  PythonGilLock lock;
  Py_DECREF(py_object_);
}

size_t VersionedLocalObjectImpl::Serialize(
...
// static
VersionedLocalObjectImpl* VersionedLocalObjectImpl::Deserialize(
